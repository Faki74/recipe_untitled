                        ...
                        InkWell(
                            onTap: () async {
                              if (textEditingController.text.isNotEmpty) {
                                ...
                                recipies = [];
                                String MainUrl = "https://api.edamam.com/api/recipes/v2";
                                String url = "${MainUrl}?type=public&q=${textEditingController.text}&app_id=1ea8415d&app_key=0bc0dbfa7e0d4efef081c98b935bed5f";
